...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:frmwrk="Corel Framework Data">
  ...
  <xsl:template match="uiConfig/items">
    <xsl:copy>
      ...
      <itemData guid="fc35b9fb-8600-4770-9a3b-b8afcdb76845"
                type="wpfhost"
                hostedType="Addons\ColorPickerTest\ColorPickerTest.dll,ColorPickerTest.ControlUI"
                enable="true"/>
    ...
    <xsl:copy>
      <xsl:apply-templates select="node()|@*"/>
        ...
        <container>
          ...
          <item dock="fill" margin="0,0,0,0" guidRef="fc35b9fb-8600-4770-9a3b-b8afcdb76845"/>
        </container>
